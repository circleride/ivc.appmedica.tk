    ...
    var t = function () {
        ...
        return function () {
            if (!t || !t.requirejs) {
                ...
                !function (t) {
                    ...
                    function o(e, t) {
                        ...
                        if ((h || g) && f) {
                            for (n = e.split("/"), u = n.length; u > 0; u -= 1) {
                                if (r = n.slice(0, u).join("/"), h)for (d = h.length; d > 0; d -= 1)if (i = f[h.slice(0, d).join("/")], i && (i = i[r])) {
                                    o = i, a = u;
                                    break
                                }
                                if (o)break;
                    ...
                    function c(e) {
                        ...
                        if (!i(m, e) && !i(_, e))throw new Error("No " + e);
                        return m[e]
                    }
                    ...
                    f = function (e, t) {
                        ...
                        var a, u, d, p, h, y, $ = [], w = typeof r;
                        if (o = o || e, "undefined" === w || "function" === w) {
                            for (n = !n.length && r.length ? ["require", "exports", "module"] : n, h = 0; h < n.length; h += 1)if (p = f(n[h], o), u = p.f, "require" === u)$[h] = g.require(e); else if ("exports" === u)$[h] = g.exports(e), y = !0; else if ("module" === u)a = $[h] = g.module(e); else if (i(m, u) || i(v, u) || i(_, u))$[h] = c(u); else {
                        ...
                        return n = n || function () {
                            }, "function" == typeof r && (r = i, i = o), i ? p(t, e, n, r) : setTimeout(function () {
                            p(t, e, n, r)
                        }, 4), h
                    }, h.config = function (e) {
                        return h(e)
            ...
            return t.Extend(n, t.Observable), n.prototype.render = function () {
                ...
                var r = e('<li role="treeitem" aria-live="assertive" class="select2-results__option"></li>'), i = this.options.get("translations").get(t.message);
            ...
            return t.Extend(r, e), r.prototype.select = function (e) {
                ...
                for (var i = this, o = this.$element.find("option"), s = o.map(function () {
                    ...
                    if (n.inArray(c.id, s) >= 0) {
                        var u = o.filter(r(c)), d = this.item(u), p = n.extend(!0, {}, d, c), h = this.option(p);
                        u.replaceWith(h)
                    } else {
                        var f = this.option(c);
                        if (c.children) {
            ...
            return t.Extend(r, e), r.prototype._applyDefaults = function (e) {
                ...
                "function" == typeof o.url && (o.url = o.url.call(this.$element, e)), "function" == typeof o.data && (o.data = o.data.call(this.$element, e)), this.ajaxOptions.delay && "" !== e.term ? (this._queryTimeout && window.clearTimeout(this._queryTimeout), this._queryTimeout = window.setTimeout(r, this.ajaxOptions.delay)) : r()
            }, r
            ...
            return t.prototype.query = function (e, t, n) {
                function r(e, o) {
                    ...
                    if (null != d) {
                        var p = i.option(d);
                        p.attr("data-select2-tag", !0), i.addOptions([p]), i.insertTag(s, d)
                    }
                    e.results = s, n(e)
                }
            ...
            return n.prototype.bind = function (e, t, n) {
                ...
                var i = this, o = "scroll.select2." + r.id, s = "resize.select2." + r.id, a = "orientationchange.select2." + r.id, l = this.$container.parents().filter(t.hasScroll);
                l.each(function () {
                ...
                var i = "scroll.select2." + r.id, o = "resize.select2." + r.id, s = "orientationchange.select2." + r.id, a = this.$container.parents().filter(t.hasScroll);
            ...
            return {
                errorLoading: function () {
                    return "Los resultados no se pueden mostrar."
                }, inputTooLong: function (e) {
                    var t = e.input.length - e.maximum, n = "Elimine " + t + " caracter";
                    return 1 != t && (n += "s"), n
                }, inputTooShort: function (e) {
                    var t = e.minimum - e.input.length, n = "Ingrese " + t + " o mas caracteres";
                    return n
                }, loadingMore: function () {
                    return "Cargando mas resultados..."
                }, maximumSelected: function (e) {
                    var t = "Solo puede seleccionar " + e.maximum + " item";
            ...
            T.prototype.apply = function (d) {
                ...
                if (null == d.resultsAdapter && (d.resultsAdapter = n, null != d.ajax && (d.resultsAdapter = c.Decorate(d.resultsAdapter, x)), null != d.placeholder && (d.resultsAdapter = c.Decorate(d.resultsAdapter, b)), d.selectOnClose && (d.resultsAdapter = c.Decorate(d.resultsAdapter, E))), null == d.dropdownAdapter) {
                    if (d.multiple)d.dropdownAdapter = $; else {
                        var D = c.Decorate($, w);
                        d.dropdownAdapter = D
                    }
